...
class PictureFactory(object):
    ...
    def _build_final_image(self, image: Image):
    ...
    def _build_texts(self, image: Image):
    ...
    def _build_outlines(self, image: Image):
    ...
    def set_background(self, color_or_path):
        ...
        if isinstance(color_or_path, (tuple, list)):
            ...
            if not os.path.isfile(color_or_path):
...
class OpenCvPictureFactory(PictureFactory):
    ...
    def _build_background(self):
        ...
        if self._background_image:
            ...
            if self._background_color[0] == self._background_color[1] and self._background_color[1] == \
                    self._background_color[2]:
...
if __name__ == '__main__':
    ...
    def main():
        ...
        imgs = [
            ...
            load_image("chu_ky.png", (600, 800)),
            # load_image("20250626T095529.jpg", (600, 800))
        ]

        factory = OpenCvPictureFactory(2480, 3508, *imgs)

        # factory.set_overlay("bg.png")
        factory.set_background("bg.png")
        factory.set_margin(margin=100)
        # factory.set_outlines(False)

        # Chèn chữ đang bị lỗi!!!!!!
        # factory.add_text("Photobooth session", "arial.ttf", (0, 0, 0), factory.CENTER)

        output = factory.build(rebuild=True)
        output.save("output_collage.jpg")
        print("Saved to output_collage.jpg")
