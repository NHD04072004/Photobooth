    ...
    <section className="min-h-screen flex items-center justify-center bg-[#FFFBEA]">
      <div className="flex flex-col items-center justify-center text-center space-y-6 cursor-pointer">
        <img
          src={picperfect}
          alt="Logo"
          className="w-[60%] max-w-md h-auto bg-[#FFFBEA] p-2 rounded-lg"
        />
          <CustomWebcam width={width} height={height} />
        <button
          onClick={handleStart}
          className="px-8 py-3 border-2 border-[#1F3A63] text-[#1F3A63] font-bold text-3xl rounded-full hover:bg-[#1F3A63]/10 transition duration-200 mt-4"
        >
          Chạm để bắt đầu
        </button>
      </div>
